		<div id="blog-box">
			...
			<div id="facebook-feed" class="show-for-large-up">
			<!-- FACEBOOK WIDGET -->
			...
			<div class="hide-for-large-up">
				<a href="http://facebook.com/uiowacab" class="button" target="_blank">Check out the latest news from CAB on our Facebook Page!</a>
			</div>
	    </div>