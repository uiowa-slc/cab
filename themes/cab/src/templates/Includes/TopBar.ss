<div class="big-header-container">
	<div class="row big-header show-for-medium-up">
		<div class="large-12 columns">
			<h1><a href="{$BaseHref}"><img src="{$ThemeDir}/dist/images/cablogo.png" alt="$SiteConfig.Title" /></a></h1>
...
<nav class="top-bar" role="navigation" data-topbar>
	<ul class="title-area">
		<li class="name hide-for-medium-up"><h1><a href="{$BaseHref}"><img src="{$ThemeDir}/dist/images/cablogo.png" alt="$SiteConfig.Title" /></a></h1></li>
